...
<?php if ( My_Home_Theme()->layout->has_header_tiktok() ) : ?>
    <span>
        <a href="<?php echo esc_url( My_Home_Theme()->layout->get_header_tiktok() ) ?>" target="_blank">
            <i class="fab fa-tiktok mh-top-header-big__element__icon-big"></i>
        </a>
    </span>
<?php endif; ?>

<?php if ( My_Home_Theme()->layout->has_header_telegram() ) : ?>
    <span>
        <a href="<?php echo esc_url( My_Home_Theme()->layout->get_header_telegram() ) ?>" target="_blank">
