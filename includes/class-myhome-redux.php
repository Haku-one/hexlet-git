			...
			$section = array(
				...
				'fields' => array(
					...
					array(
						...
						'subtitle' => '<a target="_blank" href="https://support.myhometheme.net/support/solutions/articles/101000374024">' .
					...
					array(
						...
						'subtitle' => '<a target="_blank" href="https://support.myhometheme.net/support/solutions/articles/101000373980">' . esc_html__( 'Click here to read how to get Google Maps latitude and longitude',
			...
			$section = array(
				...
				'fields'     => array(
					...
					array(
						...
						'default'  => '',
						'type'     => 'text',
						'title'    => esc_html__( 'TikTok (URL)', 'myhome' ),
						'required' => array(
							'mh-top-header-style',
							'!=',
							'none',
					...
					array(
						'id'       => 'mh-header-telegram',
						'default'  => '',
						'type'     => 'text',
						'title'    => esc_html__( 'Telegram (URL)', 'myhome' ),
						'required' => array(
							'mh-top-header-style',
							'!=',
							'none',
		...
		public function set_estate_options() {
			...
			$fields = array(
				...
				array(
					...
					'subtitle' => esc_html__( 'You can read how it works - ',
							'myhome' ) . "<a href='https://support.myhometheme.net/support/solutions/articles/101000374053' target='_blank'>here</a>",
				),
		...
		public function set_agent_options() {
			...
			$section = array(
				...
				'desc'       => esc_html__( 'If you do not get WordPress emails probably your server is blocking sending it. In this case please use SMTP solution - ',
						'myhome' ) . "<a href='https://support.myhometheme.net/support/solutions/articles/101000374008' target='_blank'>here</a>",
...
//					),
			...
			$section = array(
				...
				'fields'     => array(
					...
					array(
						...
						'subtitle' => '<a target="_blank" href="https://support.myhometheme.net/support/solutions/articles/101000378155#facebook">' .
					...
					array(
						...
						'subtitle' => '<a target="_blank" href="https://support.myhometheme.net/support/solutions/articles/101000378155#twitter">' .
					...
					array(
						...
						'subtitle' => '<a target="_blank" href="https://support.myhometheme.net/support/solutions/articles/101000378155#google">' .
					...
					//						'subtitle' => '<a target="_blank" href="https://support.myhometheme.net/support/solutions/articles/101000378155#instagram">' .
					...
					array(
						...
						'subtitle' => '<a target="_blank" href="https://support.myhometheme.net/support/solutions/articles/101000378155#linkedin">' .
					...
					//						'subtitle' => '<a target="_blank" href="https://support.myhometheme.net/support/solutions/articles/101000378155#yahoo">' .
			...
			$section = array(
				...
				'desc'       => esc_html__( 'If you do not get WordPress emails probably your server is blocking sending it. In this case please use SMTP solution - ',
						'myhome' ) . "<a href='https://support.myhometheme.net/support/solutions/articles/101000374008' target='_blank'>read more</a>",
