...
if ( ! class_exists( 'My_Home_Layout' ) ) :
	...
	class My_Home_Layout {
		...
		public function get_header_tiktok() {
			$header_tiktok = My_Home_Theme()->settings->get( 'header-tiktok' );
		...
		public function has_header_tiktok() {
			$tiktok = My_Home_Theme()->settings->get( 'header-tiktok' );

			return ! empty( $tiktok );
		}

		public function get_header_telegram() {
			$header_telegram = My_Home_Theme()->settings->get( 'header-telegram' );
		...
		public function has_header_telegram() {
			$telegram = My_Home_Theme()->settings->get( 'header-telegram' );
