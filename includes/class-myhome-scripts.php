	...
	class My_Home_Scripts {
		...
		public function load_admin_scripts() {
			...
			add_action( 'admin_head', static function () {
				...
				if (
					...
					&& $page !== 'MyHome'
					&& $page !== 'MyHomeDesign'
					&& $page !== 'MyHomeChildDesign'
					&& $page !== 'myhome_attributes'
					&& $page !== 'myhome_idx_broker'
					&& $page !== 'myhome_idx_broker_settings'
					&& $page !== 'myhome_idx_broker_mls'
					&& $page !== 'myhome_idx_broker_properties'
					&& $page !== 'myhome_importer'
					&& $page !== 'myhome-updater'
				) {
					return;
				}
                ...
                <script type='text/javascript' src='https://euc-widget.freshworks.com/widgets/101000002830.js' async
                        defer></script>
				<?php
			} );
			...
			if ( isset( $_GET['page'] ) && $_GET['page'] == 'myhome_attributes' && is_user_logged_in() ) {
				...
				wp_register_script(
					...
					apply_filters( 'myhome_google_api_url', '//maps.googleapis.com' ) . '/maps/api/js?libraries=places&key=' . $google_api_key . '&callback=mapLoaded',
					array( 'jquery' ),
					false,
					false
				);
		...
		public function load_js() {
			...
			if ( ! empty( $google_api_key ) ) {
				wp_register_script(
					'google-maps-api',
					apply_filters( 'myhome_google_api_url', '//maps.googleapis.com' ) . '/maps/api/js?key=' . $google_api_key . '&libraries=places&callback=mapLoaded',
					array( 'jquery' ),
					null,
					false
				);
